...
import { messageLogs } from "@/components/hr/hr-data";
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted">
              Automated disbursal alerts, Kendra meeting reminders, EMI thermal
              receipts, and legal default warning messages
            </p>
          </div>
        </div>
