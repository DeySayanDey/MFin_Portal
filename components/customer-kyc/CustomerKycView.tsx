...
import {
  ...
  ProfileModal,
  type KycBorrower,
} from "@/components/customer-kyc/CustomerKycModals";
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <h1 className="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">
            Borrower Profiles, Group Affiliations & KYC Vault
          </h1>
          <p className="mt-1 max-w-3xl text-sm leading-6 text-muted">
            JLG member registration, Penny Drop bank verification,
            Guarantor/Nominee records, and RBI cashflow surplus
          </p>
        </div>
