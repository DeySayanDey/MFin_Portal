...
import {
  CashBookPanel,
  TrialBalancePanel,
} from "@/components/master/CoaLedgerPanels";
import { CoaTreeView } from "@/components/master/CoaTreeView";
...
function PageIntro({
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
      ...
      {actions ? <div className="btn-actions">{actions}</div> : null}
    </div>
  );
}
  ...
  return (
    <div className="flex min-w-0 flex-col gap-4 sm:gap-5">
      <PageIntro
        ...
        subtitle="Cash/Bank Deposit, Savings Withdrawal, Office Expense & Contra with N-Level COA mapping"
        actions={
          <>
  ...
  return (
    <div className="flex min-w-0 flex-col gap-4 sm:gap-5">
      <PageIntro
        ...
        subtitle="N-Line General Ledger adjustment and non-cash inter-account entries"
        actions={
          <button type="button" className="btn btn-primary">
...
export function CashDepositView() {
  return (
    <VoucherListView
      ...
      subtitle="Branch counter and bank deposit vouchers with Dr/Cr posting and thermal print"
      icon={<Banknote className="h-5 w-5" />}
      filterHint="Search voucher no, name..."
    />
  );
}
...
export function SavingsWithdrawalView() {
  return (
    <VoucherListView
      ...
      subtitle="Member Bachat Gat / savings withdrawals with official thermal voucher print"
  ...
  return (
    <div className="flex min-w-0 flex-col gap-4 sm:gap-5">
      <PageIntro
        ...
        subtitle="Vault ↔ Bank contra postings with maker-checker dual sign-off"
        actions={
          <button type="button" className="btn btn-primary">
  ...
  return (
    <div className="flex min-w-0 flex-col gap-4 sm:gap-5">
      <PageIntro
        ...
        subtitle="Consolidated trial balance across all COA levels with Dr/Cr invariant"
      />
      <TrialBalancePanel />
    </div>
  );
  ...
  return (
    <div className="flex min-w-0 flex-col gap-4 sm:gap-5">
      <PageIntro
        ...
        subtitle="Cash-in-hand and bank disbursement / collection register"
      />
      <CashBookPanel />
    </div>
  );
