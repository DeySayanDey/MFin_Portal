      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-muted-soft">
            RBI Compliant MFI Accounting · Double-Entry Invariant Guarded
          </p>
          <h1 className="mt-1 text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">
            eZi-Micro General Ledger Architecture
          </h1>
          <p className="mt-1 text-sm text-muted">
            N-Level Chart of Accounts (COA), Sub-Ledger master, dynamic Trial
            Balance & GL-wise statements
          </p>
        </div>
