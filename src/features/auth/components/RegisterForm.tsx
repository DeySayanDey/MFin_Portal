...
export function RegisterForm() {
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    // UI-only until a documented Laravel register API exists.
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="rounded-xl border border-amber-200/80 bg-amber-50 px-3.5 py-3 text-xs leading-5 text-amber-950">
        Staff registration API is not available yet. This form is UI-only until
        the backend documents a register endpoint.
      </div>
